...
public class PassingYearbooks {
    ...
    public static void main(String args[]) {
        System.out.println("\nInput: arr=[2,1] \nOutput: " + Arrays.toString(PassingYearbooks.findSignatureCounts(new int[]{2,1})));
        System.out.println("\nInput: arr=[1,2] \nOutput: " + Arrays.toString(PassingYearbooks.findSignatureCounts(new int[]{1,2})));
        System.out.println("\nInput: arr=[1,2,3] \nOutput: " + Arrays.toString(PassingYearbooks.findSignatureCounts(new int[]{1,2,3})));
        System.out.println("\nInput: arr=[3,2,1] \nOutput: " + Arrays.toString(PassingYearbooks.findSignatureCounts(new int[]{3,2,1})));
        System.out.println("\nInput: arr=[3,1,2] \nOutput: " + Arrays.toString(PassingYearbooks.findSignatureCounts(new int[]{3,1,2})));
        System.out.println("\nInput: arr=[1,3,2] \nOutput: " + Arrays.toString(PassingYearbooks.findSignatureCounts(new int[]{1,3,2})));
    }
}
