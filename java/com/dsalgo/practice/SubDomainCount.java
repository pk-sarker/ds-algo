        ...
        for(int i=0; i<cpdomains.length;i++) {
            ...
            for(int j=n-1; j>=0; j--) {
                if  (subdomain.isEmpty()) {
                    ...
                    subdomain = domains[j] + "." + subdomain;
                }
                domainCountMap.put(subdomain, domainCountMap.getOrDefault(subdomain, 0)+count);
            }
        }

        for(String key : domainCountMap.keySet())  {
            result.add(domainCountMap.get(key) + " " +key);
        }
        return result;
    }

    public static void main(String args[]) {
        System.out.println("\nInput: [\"100 discuss.leetcode.com\", \"10 about.leetcode.com\", \"6 contact.leetcode.com\"] \nOutput: " + SubDomainCount.subdomainVisits(new  String[]{"100 discuss.leetcode.com", "10 about.leetcode.com", "6 contact.leetcode.com"}));
    }
}
