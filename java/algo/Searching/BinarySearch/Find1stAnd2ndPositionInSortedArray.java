...
public class Find1stAnd2ndPositionInSortedArray {
    ...
    public static void main(String args[]) {
        ...
        System.out.println("\nInput: [5,7,7,8,8,10] target=6\nOutput: " + Arrays.toString(Find1stAnd2ndPositionInSortedArray.findRange(new int[]{5,7,7,8,8,10}, 6)));

        System.out.println("\nInput: [1,2,2,5,7,7,8,8,8,8,8,10] target=8\nOutput: " + Arrays.toString(Find1stAnd2ndPositionInSortedArray.findRange(new int[]{1,2,2,5,7,7,8,8,8,8,8,10}, 8)));

        System.out.println("\nInput: [1,2] target=2\nOutput: " + Arrays.toString(Find1stAnd2ndPositionInSortedArray.findRange(new int[]{1,2}, 2)));
        System.out.println("\nInput: [1,2] target=1\nOutput: " + Arrays.toString(Find1stAnd2ndPositionInSortedArray.findRange(new int[]{1,2}, 1)));
